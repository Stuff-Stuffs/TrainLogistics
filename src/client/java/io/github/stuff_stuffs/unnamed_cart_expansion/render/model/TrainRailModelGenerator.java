package io.github.stuff_stuffs.unnamed_cart_expansion.render.model;
...
public final class TrainRailModelGenerator {
    ...
    public static void generate(final RailInfo info, final QuadEmitter emitter, final int segments, final int railColor, final RenderMaterial railMaterial, final int tieColor, final RenderMaterial tieMaterial) {
